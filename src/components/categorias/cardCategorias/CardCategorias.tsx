...
import Categoria from '../../../models/Categoria'; // Troquei Tema por Categoria
...
function CardCategorias({ categoria }: CardCategoriaProps) { 
  return (
    <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
      ...
      <div className="flex">
        <Link to={`/AtualizarCategorias/${categoria.id}`} className='w-full text-slate-100 bg-indigo-400 hover:bg-indigo-800 flex items-center justify-center py-2'>
